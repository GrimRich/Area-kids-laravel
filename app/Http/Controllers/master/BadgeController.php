...
use App\Http\Requests\master\badgeStore;
...
class BadgeController extends Controller
{
    ...
    public function updateOrCreate(badgeStore $request)
    {
    ...
    {
        $data = Badge::select('id as value', 'nama as text')->get();
    ...
    {
        $data = Badge::select('id as value', 'nama as text')->where('id', $request->id)->get();
